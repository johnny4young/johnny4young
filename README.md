...
Backend engineer specialized in **Node.js**, **TypeScript**, and **Go**, with deep focus on **distributed systems**, **developer tooling**, and **production-grade LLM applications** — and a growing line of **native Apple apps in Swift** (macOS · iOS · iPadOS).
...
- 📋 **[Gancho](https://github.com/johnny4young/gancho)** — **Smart Clipboard** for the Apple ecosystem: a local-first clipboard history and curated snippet library for Mac, iPhone & iPad. GRDB/SQLite with FTS5 search, a Liquid Glass history panel, paste-back, pins & boards, on-device intelligence, and serverless iCloud sync via `CKSyncEngine`. Private by design — your data stays on your devices. [gancho.app](https://gancho.app) &nbsp; ![Swift](https://img.shields.io/badge/Swift-F05138?style=flat-square&logo=swift&logoColor=white) ![Apple](https://img.shields.io/badge/macOS%20·%20iOS%20·%20iPadOS-000000?style=flat-square&logo=apple&logoColor=white) [![Stars](https://img.shields.io/github/stars/johnny4young/gancho?style=flat-square&label=★)](https://github.com/johnny4young/gancho)
- 🖼️ **[Vitrine](https://github.com/johnny4young/vitrine)** — Turn code into beautiful images, straight from your macOS menu bar. Native, instant, fully local — no account, no network. [vitrineframe.app](https://vitrineframe.app) &nbsp; ![Swift](https://img.shields.io/badge/Swift-F05138?style=flat-square&logo=swift&logoColor=white) ![macOS](https://img.shields.io/badge/macOS-000000?style=flat-square&logo=apple&logoColor=white) [![Stars](https://img.shields.io/github/stars/johnny4young/vitrine?style=flat-square&label=★)](https://github.com/johnny4young/vitrine)
- 🛒 **[Puntovivo](https://github.com/johnny4young/puntovivo)** — A **local-first, fiscal-native POS** for Latin American retail. Electron + React + Fastify + tRPC + SQLite, sharing one app across desktop and web. Offline local authority, tenant-scoped data with role guards and audit logs, cash sessions, site-owned stock, and fiscal-document foundations — first wedge is Colombia retail. [puntovivo.app](https://puntovivo.app) &nbsp; ![TypeScript](https://img.shields.io/badge/TypeScript-3178C6?style=flat-square&logo=typescript&logoColor=white) ![tRPC](https://img.shields.io/badge/tRPC-2596BE?style=flat-square&logo=trpc&logoColor=white) [![Stars](https://img.shields.io/github/stars/johnny4young/puntovivo?style=flat-square&label=★)](https://github.com/johnny4young/puntovivo)
- 🧠 **[Lingua](https://github.com/johnny4young/lingua)** — **Multi-language desktop code runner** — JavaScript, TypeScript, Python, Go, Rust, and Ruby in one offline-first, Monaco-powered app (desktop + web). The multi-language answer to RunJS: same "open, write, run" ergonomics, but with Go, Rust, Python, and Ruby as first-class citizens. Source-available commercial product. [linguacode.dev](https://www.linguacode.dev/) &nbsp; ![Electron](https://img.shields.io/badge/Electron-47848F?style=flat-square&logo=electron&logoColor=white) ![TypeScript](https://img.shields.io/badge/TypeScript-3178C6?style=flat-square&logo=typescript&logoColor=white) [![Stars](https://img.shields.io/github/stars/johnny4young/lingua?style=flat-square&label=★)](https://github.com/johnny4young/lingua)
...
A native macOS menu-bar app that turns snippets into share-ready images. Native, instant, and fully local — no account, no network, nothing leaves your machine. [Visit the website →](https://vitrineframe.app)
